...
namespace RockPaperScissors.Screens
{
    public class LS_ResultScreen
    {
        ...
        public LS_ResultScreen(Renderer renderer, GameStateManager gameStateManager, SpriteBatch spriteBatch)
        {
            _renderer = renderer;
        ...
        public LS_ResultScreen(InputHandler inputHandler, GameStateManager gameStateManager, GameLogic gameLogic) 
        { 
